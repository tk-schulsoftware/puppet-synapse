...
class synapse(
    ...
    Float   $rc_message_burst_count = 15,
    Float   $rc_registration_per_second = 0.15,
    Float   $rc_registration_burst_count = 2,
    Float   $rc_registration_token_validity_per_second = 0.3,
    Float   $rc_registration_token_validity_burst_count = 6,
    Float   $rc_login_address_per_second = 0.15,
    Float   $rc_login_address_burst_count = 5,
    Float   $rc_login_account_per_second = 0.18,
    Float   $rc_login_account_burst_count = 4,
    Float   $rc_login_failed_attempts_per_second = 0.19,
    Float   $rc_login_failed_attempts_burst_count = 7,
    Float   $rc_admin_redaction_per_second = 1,
    Float   $rc_admin_redaction_burst_count = 50,
    Float   $rc_joins_local_per_second = 0.2,
    Float   $rc_joins_local_burst_count = 15,
    Float   $rc_joins_remote_per_second = 0.3,
    Float   $rc_joins_remote_burst_count = 12,
    Float   $rc_joins_per_room_per_second = 1,
    Float   $rc_joins_per_room_burst_count = 10,
    Float   $rc_3pid_validation_per_second = 0.003,
    Float   $rc_3pid_validation_burst_count = 5,
    Float   $rc_invites_per_room_per_second = 0.5,
    Float   $rc_invites_per_room_burst_count = 5,
    Float   $rc_invites_per_user_per_second = 0.004,
    Float   $rc_invites_per_user_burst_count = 3,
    Float   $rc_invites_per_issuer_per_second = 0.5,
    Float   $rc_invites_per_issuer_burst_count = 5,
    Float   $rc_third_party_invite_per_second = 0.2,
    Float   $rc_third_party_invite_burst_count = 10,
    Float   $rc_federation_window_size = 750,
    Float   $rc_federation_sleep_limit = 15,
    Float   $rc_federation_sleep_delay = 400,
    Float   $rc_federation_reject_limit = 40,
    Float   $rc_federation_concurrent = 5,
    Float   $federation_rr_transactions_per_room_per_second = 40,
) {
